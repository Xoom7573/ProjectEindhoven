const posts = [
  ...
  },
  {
    ...
    alineas: [
      "Day 4 of our international project week in Eindhoven was busy.",
      "We had been working hard on our projects for the past few days and it was time to finalize and test everything before presenting it to the jury.",
      "We focused on putting the final touches on our projects and we got to go outside to test our applications and see how it influenced our behavior.",
      "It was a critical step to ensure that our projects were functioning correctly and met our client's requirements.",
      "At 11 am, we had our final and last wrap-up presentation.",
      "We presented our projects to our fellow participants and received valuable feedback from them.",
      "After the presentation, we took a lunch break and enjoyed a variety of delicious sandwiches.",
      "In the afternoon, we had the chance to explore the city of Eindhoven with a guided tour.",
      "We learned about the city's history, culture, and architecture.",
      "We also had the opportunity to see some of Eindhoven's famous landmarks and museums, such as the Van Abbemuseum, the Philips Museum, and the Strijp-S area.",
      "The tour was a great way to take a break from our projects and bond with our fellow participants.",
      "Overall we were able to finalize our projects, receive feedback and explore the beautiful city of Eindhoven.",
    ],
  },
  {
    ...
    alineas: [
      "Our last day of our international project week in Eindhoven.",
      "We started the day with our usual daily start at 9 am, but this time it was focused on finalizing our projects.",
      "At 10:30, it was time for us to present our projects to the jury.",
      "We're all nervous but excited to share our ideas with them.",
      "Each group presented their project, showcasing their unique selling point and how they had addressed their users' needs.",
      "It was impressive to see how much progress we had made.",
      "After the presentations, we had a well-deserved lunch break to relax and enjoy some food together.",
      "It was a great opportunity to talk with our teams and reflect on the past week's experiences.",
      "At 1 pm, we gathered for the award ceremony and received our certificates.",
      "It was a proud moment for all of us to see our hard work pay off and be recognized by the experts and our peers.",
      "The day ended with goodbyes.",
      "It was a bit sad to say goodbye to our new friends and colleagues, but we were grateful for the opportunity to have worked together and learned from each other.",
      "We left Eindhoven with new skills, experiences, and memories that we will cherish forever.",
      "Overall, the international project week in Eindhoven was a fantastic experience that pushed us out of our comfort zones and allowed us to grow both personally and professionally.",
      "We were grateful for the opportunity to participate and are excited to see where our newfound knowledge and skills will take us in the future.",
    ],
  },
];
